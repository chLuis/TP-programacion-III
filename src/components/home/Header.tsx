    ...
    <header id="home" className="relative min-h-[500px] grid grid-cols-2 gap-y-2 max-w-7xl mx-auto">
      <div className="order-2 md:order-1 col-span-2 md:col-span-1 m-auto w-full px-4 md:ps-12 z-[9999]">
        ...
        <div className="flex justify-center md:justify-start flex-wrap gap-3">
          <a href="https://github.com/chLuis" target="_blank" aria-label="github" className="flex flex-col gap-0">
            <InteractiveHoverButton className="border-blue-600">
              <FaGithub  />
            </InteractiveHoverButton>
          </a>
          <a href="https://www.linkedin.com/in/luis-chrestia/" aria-label="linkedin" target="_blank">
            <InteractiveHoverButton className="border-blue-600">
              <FaLinkedin  />
            </InteractiveHoverButton>
          </a>
          <a href="mailto:chluisdev@gmail.com" aria-label="email" target="_blank">
            <InteractiveHoverButton className="border-blue-600">
              <FaMailBulk  />
            </InteractiveHoverButton>
          </a>
          <a href="https://drive.google.com/file/d/1ShvbbHdJrn2rIbTmC-ljW7UfviXQSfva/view?usp=sharing" aria-label="cv-pdf" target="_blank">
            <InteractiveHoverButton className="border-blue-600">
              <FaFilePdf />
            </InteractiveHoverButton>
          </a>
